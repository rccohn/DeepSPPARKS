...
#  ../../datasets/node_edge_patch_dataset/patch_compression.py
# if this is used a lot it should eventually
# be incorporated into deepspparks module, to avoid
# having redundant code and the difficulties associated
# with maintaining it
import numpy as np
